...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'guest.create': {
    roles: ['owner', 'manager', 'sales-associate'],
    key: 'new-guest-profile',
    tenantPath: ['organization', 'user', 'guest'],
    userPath: [],
  },
  'sales_associate.update': {
    roles: ['owner', 'manager'],
    key: 'sales-associate-update',
    tenantPath: ['organization', 'user', 'sales_associate'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'manager', 'sales-associate', 'inventory-specialist'];
