...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`watch store management application`}</title>

        <meta
          name="description"
          content="Seamlessly Streamline Your Business with Watch Store Management Application - Your Ultimate Solution for Efficient and Effective Watch Store Operations."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1524805444758-089113d48a6d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXRjaHxlbnwwfHx8fDE2OTMzNjk3NzV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ptaylor_?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Pat Taylor`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`watch store management application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Seamlessly Streamline Your Business with Watch Store Management Application - Your Ultimate Solution for Efficient and Effective Watch Store Operations.`}
            </Text>
            <Box
