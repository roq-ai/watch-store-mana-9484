...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getInventories({
        ...
        order: params.order,
        searchTermKeys: ['watch_name.contains', 'watch_model.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'watch_name', header: 'Watch Name', accessorKey: 'watch_name' },
    { id: 'watch_model', header: 'Watch Model', accessorKey: 'watch_model' },
