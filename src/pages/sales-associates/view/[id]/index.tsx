        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Sales Target" text={data?.sales_target} />

                <FormListItem label="Sales Achieved" text={data?.sales_achieved} />

                <FormListItem label="Commission Rate" text={data?.commission_rate} />
