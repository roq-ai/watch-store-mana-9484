      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'visit_duration',
              isInvalid: !!formik.errors?.visit_duration,
            }}
            name="visit_duration"
            error={formik.errors?.visit_duration}
            value={formik.values?.visit_duration}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('visit_duration', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'interest_level',
              isInvalid: !!formik.errors?.interest_level,
            }}
            name="interest_level"
            error={formik.errors?.interest_level}
            value={formik.values?.interest_level}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('interest_level', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
